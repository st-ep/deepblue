...
# Create unscaled version by inverse transforming the scaled predictions
testing_data_unscaled = testing_data.copy()
testing_data_unscaled['Estimated Average Stage Time'] = time_scaler.inverse_transform(
    testing_data[['Estimated Average Stage Time']]
)

# Save the unscaled results
testing_data_unscaled.to_csv('not_scaled_testing_with_predictions.csv', index=False)
